...
class LoginController(private val loginService: LoginService) {
	...
	/**
	 * Endpoint to verify if a user is authorized by its token generated by login endpoint if it was successfully
	 * @param role The person role that we expect it has
	 * @return the token payload content if it is not expired and if the given role matches with the expected
	 * @see login
	 * @see PersonRole
	 * @see PayloadResponse
	 */

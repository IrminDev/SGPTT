package com.sgptt.protocolservice.security;

import com.sgptt.protocolservice.dto.AuthDTO;
...
public class RoleCheckAspect {
	...
	public void checkRole(RequiresRole requiresRole) throws SecurityException {
		...
		try {
			response = request.get().uri("/api/auth/authorize/me").headers(
					headers -> headers.add("Authorization", token)
			)
					.retrieve()
